...
public class HR_PlayerEditor : Editor {
  ...
  void CreatePrefab() {
    PrefabUtility.SaveAsPrefabAssetAndConnect(prop.gameObject,
      "Assets/Highway Racer/Resources/Player Vehicles/" + prop.gameObject.name + ".prefab", InteractionMode.UserAction);
