...
public class HR_EditorWindows : Editor {
  ...
  public static void QuickSwitchToDesktop() {
    ...
    RCC_Settings.Instance.controllerSelectedIndex = 0;
  ...
  public static void QuickSwitchToMobile() {
    Selection.activeObject = RCC_Settings.Instance;
    RCC_Settings.Instance.controllerSelectedIndex = 1;
  ...
  public static void OpenDocs() {
    string url =
      "https://dl.dropboxusercontent.com/u/248930654/_Documentations/Highway%20Racer%20Complete%20Project.pdf";
