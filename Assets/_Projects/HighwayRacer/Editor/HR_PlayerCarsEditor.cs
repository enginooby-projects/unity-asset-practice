...
public class HR_PlayerCarsEditor : Editor {
  ...
  public override void OnInspectorGUI() {
    ...
    for (int i = 0; i < prop.cars.Length; i++) {
      ...
      prop.cars[i].vehicleName =
        EditorGUILayout.TextField("Player Car Name", prop.cars[i].vehicleName, GUILayout.MaxWidth(475f));

      EditorGUILayout.Space();
      EditorGUILayout.BeginHorizontal();
      prop.cars[i].playerCar = (GameObject) EditorGUILayout.ObjectField("Player Car Prefab", prop.cars[i].playerCar,
        typeof(GameObject), false, GUILayout.MaxWidth(475f));
      ...
      if (prop.cars[i].playerCar && prop.cars[i].playerCar.GetComponent<RCC_CarControllerV3>()) {
        ...
        prop.cars[i].playerCar.GetComponent<RCC_CarControllerV3>().maxspeed = EditorGUILayout.FloatField("Speed",
          prop.cars[i].playerCar.GetComponent<RCC_CarControllerV3>().maxspeed, GUILayout.MaxWidth(150f));
        prop.cars[i].playerCar.GetComponent<HR_ModApplier>().highwaySteeringHelper = EditorGUILayout.FloatField(
          "Handling", prop.cars[i].playerCar.GetComponent<HR_ModApplier>().highwaySteeringHelper,
          GUILayout.MaxWidth(150f));
        prop.cars[i].playerCar.GetComponent<HR_ModApplier>().highwayBrakingHelper = EditorGUILayout.FloatField(
          "Braking", prop.cars[i].playerCar.GetComponent<HR_ModApplier>().highwayBrakingHelper,
          GUILayout.MaxWidth(150f));
        EditorGUILayout.EndHorizontal();
        EditorGUILayout.Space();
        EditorGUILayout.BeginHorizontal();
        prop.cars[i].playerCar.GetComponent<HR_ModApplier>().maxUpgradeSpeed = EditorGUILayout.FloatField("Max Speed",
          Mathf.Clamp(prop.cars[i].playerCar.GetComponent<HR_ModApplier>().maxUpgradeSpeed,
            prop.cars[i].playerCar.GetComponent<RCC_CarControllerV3>().maxspeed, 360f), GUILayout.MaxWidth(150f));
        prop.cars[i].playerCar.GetComponent<HR_ModApplier>().maxUpgradeHandling = EditorGUILayout.FloatField(
          "Max Handling",
          Mathf.Clamp(prop.cars[i].playerCar.GetComponent<HR_ModApplier>().maxUpgradeHandling,
            prop.cars[i].playerCar.GetComponent<HR_ModApplier>().highwaySteeringHelper, 10f), GUILayout.MaxWidth(150f));
        prop.cars[i].playerCar.GetComponent<HR_ModApplier>().maxUpgradeBrake = EditorGUILayout.FloatField("Max Braking",
          Mathf.Clamp(prop.cars[i].playerCar.GetComponent<HR_ModApplier>().maxUpgradeBrake,
            prop.cars[i].playerCar.GetComponent<HR_ModApplier>().highwayBrakingHelper, 10f), GUILayout.MaxWidth(150f));
      ...
      if (prop.cars != null && prop.cars[i] != null && prop.cars[i].playerCar) {
        prop.cars[i].playerCar.GetComponent<RCC_CarControllerV3>().maxEngineTorque = EditorGUILayout.FloatField(
          "Engine Torque", prop.cars[i].playerCar.GetComponent<RCC_CarControllerV3>().maxEngineTorque,
          GUILayout.MaxWidth(150f));
