...
namespace Project.HighwayRacer {
  public class HR_GamePlayHandler : MonoBehaviour {
    ...
    [Header("Time Of The Scene")] public DayOrNight dayOrNight;
    ...
    [Header("Current Mode")] internal Mode mode;
    ...
    [Header("Spawn Location Of The Cars")] public Transform spawnLocation;
    ...
    void Awake() {
      ...
      if (HR_HighwayRacerProperties.Instance.gameplayClips != null &&
        ...
        gameplaySoundtrack = HR_CreateAudioSource.NewAudioSource(gameObject, "GamePlay Soundtrack", 0f, 0f, .35f,
          HR_HighwayRacerProperties.Instance.gameplayClips[
            UnityEngine.Random.Range(0, HR_HighwayRacerProperties.Instance.gameplayClips.Length)], true, true, false);
    ...
    void SpawnCar() {
      player = (RCC.SpawnRCC(
        HR_PlayerCars.Instance.cars[selectedCarIndex].playerCar.GetComponent<RCC_CarControllerV3>(),
        spawnLocation.position, spawnLocation.rotation, true, false, true)).gameObject;
