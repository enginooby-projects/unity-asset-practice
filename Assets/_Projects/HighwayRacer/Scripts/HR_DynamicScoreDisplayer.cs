...
//			scoreTexts [i].transform.Translate (Vector3.up * Time.deltaTime * 75f, Space.World);
        scoreTexts[i].color = Color.Lerp(scoreTexts[i].color,
          new Color(scoreTexts[i].color.r, scoreTexts[i].color.g, scoreTexts[i].color.b, 0f), Time.deltaTime * 10f);
      }

      if (timer > 0) {
        scoreTexts[index].color =
          new Color(scoreTexts[index].color.r, scoreTexts[index].color.g, scoreTexts[index].color.b, 1f);
      }
    }
