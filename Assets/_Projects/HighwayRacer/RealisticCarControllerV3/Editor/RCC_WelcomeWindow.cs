...
public class RCC_WelcomeWindow : EditorWindow {
  ...
  public static void WelcomePageContent() {
    ...
    GUILayout.Label(
      "<b>Thank you for purchasing and using Realistic Car Controller. Please read the documentation before use. Also check out the online documentation for updated info. Have fun :)</b>");
    ...
    EditorGUILayout.HelpBox(
      "Realistic Car Controller needs configured Tags & Layers and Input Manager in your Project Settings. Importing them will overwrite your Project Settings!",
    ...
    EditorGUILayout.BeginHorizontal("box");
    GUILayout.Label(
      "<b>If you don't want to overwrite your project settings, you can create a new layer named ''RCC'' and select it in RCC Settings (Tools --> BCG --> RCC --> Edit Settings --> Tags & Layers section.) More info can be found in documentation (First To Do).</b>");
    EditorGUILayout.EndHorizontal();
    ...
    EditorGUILayout.HelpBox(
      "If you want to add Photon PUN2 scenes, import and install Photon PUN2 & integration first. Then click again to add those scenes to your Build Settings.",
      MessageType.Info, true);
    EditorGUILayout.HelpBox(
      "If you want to add Enter / Exit scenes, import BCG Shared Assets to your project first. Then click again to add those scenes to your Build Settings.",
      MessageType.Info, true);
    EditorGUILayout.Separator();
    ...
    if (GUILayout.Button("Delete all demo contents from the project")) {
      if (EditorUtility.DisplayDialog("Warning",
            "You are about to delete all demo contents such as vehicle models, vehicle prefabs, vehicle textures, all scenes, scene models, scene prefabs, scene textures!",
            "Delete", "Cancel"))
        DeleteDemoContent();
    }
  ...
  public static void UpdatePageContent() {
    ...
    EditorGUILayout.BeginHorizontal("box");
    GUILayout.Label(
      "<b>2</b>- If you have own assets such as prefabs, audioclips, models, scripts in RealisticCarControllerV3 folder, keep your own asset outside from RealisticCarControllerV3 folder.");
    EditorGUILayout.EndHorizontal();
    GUILayout.Space(6);
  ...
  public static void DemosPageContent() {
    ...
    if (BCGInstalled) {
      ...
      EditorGUILayout.HelpBox("You have to import latest BCG Shared Assets to your project first.",
        MessageType.Warning);
  ...
  public static void Addons() {
    ...
    if (!photonAndRCCInstalled) {
      if (!photonInstalled) {
        ...
        EditorGUILayout.HelpBox(
          "Found Photon PUN2, You can import integration package and open Photon demo scenes now.", MessageType.Info);
...
#if BCG_ENTEREXIT
			EditorGUILayout.LabelField("BCG Shared Assets Version: " + BCG_EnterExitSettings.BCGVersion, EditorStyles.centeredGreyMiniLabel);
#endif
      GUILayout.Space(6);
    }
  ...
  public static void Documentations() {
    ...
    EditorGUILayout.BeginVertical("box");
    EditorGUILayout.HelpBox("Latest online documentations for scripts, settings, setup, how to do, and API.",
      MessageType.Info);
