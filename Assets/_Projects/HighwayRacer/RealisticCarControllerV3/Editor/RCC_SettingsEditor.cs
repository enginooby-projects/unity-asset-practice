  ...
  public override void OnInspectorGUI() {
    ...
    if (foldGeneralSettings) {
      ...
      EditorGUILayout.PropertyField(serializedObject.FindProperty("overrideFixedTimeStep"),
        new GUIContent("Override FixedTimeStep"));
      ...
      EditorGUILayout.PropertyField(serializedObject.FindProperty("maxAngularVelocity"),
        new GUIContent("Maximum Angular Velocity"));
      ...
      EditorGUILayout.PropertyField(serializedObject.FindProperty("useFixedWheelColliders"),
        new GUIContent("Use Fixed WheelColliders", "Improves stability by increasing mass of the WheelColliders."));
      EditorGUILayout.PropertyField(serializedObject.FindProperty("lockAndUnlockCursor"),
        new GUIContent("Locks Cursor", "Locks Cursor."));
    ...
    if (foldBehaviorSettings) {
      ...
      RCCSettingsAsset.overrideBehavior =
        EditorGUILayout.BeginToggleGroup("Override Behavior", RCCSettingsAsset.overrideBehavior);

      EditorGUI.indentLevel++;
      EditorGUIUtility.labelWidth = 305;
      EditorGUILayout.PropertyField(serializedObject.FindProperty("behaviorTypes"), new GUIContent("Behavior Types"),
        true);
      EditorGUIUtility.labelWidth = 250;
      ...
      RCCSettingsAsset.behaviorSelectedIndex =
        GUILayout.Toolbar(RCCSettingsAsset.behaviorSelectedIndex, behaviorTypeStrings.ToArray());
    ...
    if (foldControllerSettings) {
      ...
      controllerTypeStrings.Add("Keyboard");
      controllerTypeStrings.Add("Mobile");
      controllerTypeStrings.Add("XBox");
      controllerTypeStrings.Add("PS4");
      controllerTypeStrings.Add("Logitech Steering Wheel");
      controllerTypeStrings.Add("Custom");
      EditorGUILayout.BeginVertical(GUI.skin.box);

      GUI.color = new Color(.5f, 1f, 1f, 1f);
      GUILayout.Label("Main Controller Type", EditorStyles.boldLabel);
      RCCSettingsAsset.controllerSelectedIndex =
        GUILayout.Toolbar(RCCSettingsAsset.controllerSelectedIndex, controllerTypeStrings.ToArray());
      GUI.color = originalGUIColor;
      EditorGUILayout.Space();
      ...
      if (RCCSettingsAsset.controllerSelectedIndex == 0) {
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("verticalInput"),
          new GUIContent("Gas/Reverse Input Axis"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("horizontalInput"),
          new GUIContent("Steering Input Axis"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("mouseXInput"),
          new GUIContent("Mouse X Input Axis"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("mouseYInput"),
          new GUIContent("Mouse Y Input Axis"));
        GUI.color = new Color(.75f, 1f, .75f);
        EditorGUILayout.HelpBox(
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("startEngineKB"),
          new GUIContent("Start / Stop Engine Key"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("lowBeamHeadlightsKB"),
          new GUIContent("Low Beam Headlights"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("highBeamHeadlightsKB"),
          new GUIContent("High Beam Headlights"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("changeCameraKB"), new GUIContent("Change Camera"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("rightIndicatorKB"),
          new GUIContent("Indicator Right"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("leftIndicatorKB"),
          new GUIContent("Indicator Left"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("hazardIndicatorKB"),
          new GUIContent("Indicator Hazard"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("shiftGearUp"), new GUIContent("Gear Shift Up"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("shiftGearDown"),
          new GUIContent("Gear Shift Down"));
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("trailerAttachDetach"),
          new GUIContent("Trailer Attach/Detach"));
        EditorGUILayout.Space();
      ...
      if (RCCSettingsAsset.controllerSelectedIndex == 1) {
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("mobileController"),
          new GUIContent("Mobile Controller"));

        GUI.color = new Color(.75f, 1f, .75f);
        EditorGUILayout.HelpBox("In this mode, all inputs will be received from UI buttons.", MessageType.Info);
        GUI.color = originalGUIColor;

        EditorGUILayout.PropertyField(serializedObject.FindProperty("UIButtonSensitivity"),
          new GUIContent("UI Button Sensitivity"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("UIButtonGravity"),
          new GUIContent("UI Button Gravity"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("gyroSensitivity"),
          new GUIContent("Gyro Sensitivity"));

        EditorGUILayout.Space();

        GUI.color = new Color(.75f, 1f, .75f);
        EditorGUILayout.HelpBox(
          "You can enable/disable Accelerometer in your game by just calling ''RCCSettings.Instance.useAccelerometerForSteering = true/false;''.",
          MessageType.Info);
        EditorGUILayout.HelpBox(
          "You can enable/disable Steering Wheel Controlling in your game by just calling ''RCCSettings.Instance.useSteeringWheelForSteering = true/false;''.",
          MessageType.Info);
        GUI.color = originalGUIColor;
        EditorGUILayout.Space();
      ...
      if (RCCSettingsAsset.controllerSelectedIndex == 2) {
        ...
        GUI.color = new Color(.75f, 1f, .75f);
        EditorGUILayout.HelpBox("In this mode, inputs will be received from XBox 360 & One controllers.",
          MessageType.Info);
        GUI.color = originalGUIColor;

        EditorGUILayout.PropertyField(serializedObject.FindProperty("Xbox_triggerRightInput"),
          new GUIContent("Gas Input Axis"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("Xbox_triggerLeftInput"),
          new GUIContent("Brake/Reverse Input Axis"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("Xbox_horizontalInput"),
          new GUIContent("Steering Input Axis"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("Xbox_mouseXInput"),
          new GUIContent("Mouse X Input Axis"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("Xbox_mouseYInput"),
          new GUIContent("Mouse Y Input Axis"));
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("Xbox_startEngineKB"),
          new GUIContent("Start / Stop Engine Key"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("Xbox_lowBeamHeadlightsKB"),
          new GUIContent("Low Beam Headlights"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("Xbox_highBeamHeadlightsKB"),
          new GUIContent("High Beam Headlights"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("Xbox_changeCameraKB"),
          new GUIContent("Change Camera"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("Xbox_indicatorKB"),
          new GUIContent("Indicator Axis"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("Xbox_hazardIndicatorKB"),
          new GUIContent("Indicator Hazard"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("Xbox_shiftGearUp"),
          new GUIContent("Gear Shift Up"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("Xbox_shiftGearDown"),
          new GUIContent("Gear Shift Down"));
...
//				EditorGUILayout.PropertyField(serializedObject.FindProperty("Xbox_playbackKB"), new GUIContent("Playback"));
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("Xbox_trailerAttachDetach"),
          new GUIContent("Trailer Attach/Detach"));
        EditorGUILayout.Space();
      ...
      if (RCCSettingsAsset.controllerSelectedIndex == 3) {
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("PS4_triggerRightInput"),
          new GUIContent("Gas Input Axis"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("PS4_triggerLeftInput"),
          new GUIContent("Brake/Reverse Input Axis"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("PS4_horizontalInput"),
          new GUIContent("Steering Input Axis"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("PS4_mouseXInput"),
          new GUIContent("Mouse X Input Axis"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("PS4_mouseYInput"),
          new GUIContent("Mouse Y Input Axis"));
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("PS4_startEngineKB"),
          new GUIContent("Start / Stop Engine Key"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("PS4_lowBeamHeadlightsKB"),
          new GUIContent("Low Beam Headlights"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("PS4_highBeamHeadlightsKB"),
          new GUIContent("High Beam Headlights"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("PS4_changeCameraKB"),
          new GUIContent("Change Camera"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("PS4_indicatorKB"),
          new GUIContent("Indicator Axis"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("PS4_hazardIndicatorKB"),
          new GUIContent("Indicator Hazard"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("PS4_shiftGearUp"),
          new GUIContent("Gear Shift Up"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("PS4_shiftGearDown"),
          new GUIContent("Gear Shift Down"));
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("PS4_trailerAttachDetach"),
          new GUIContent("Trailer Attach/Detach"));
        EditorGUILayout.Space();
      ...
      if (RCCSettingsAsset.controllerSelectedIndex == 4) {
        ...
        GUI.color = new Color(.75f, 1f, .75f);
        EditorGUILayout.HelpBox("In this mode, inputs will be received from Logitech Steering Wheel.",
          MessageType.Info);
        EditorGUILayout.Space();
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("LogiSteeringWheel_handbrakeKB"),
          new GUIContent("Handbrake"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("LogiSteeringWheel_startEngineKB"),
          new GUIContent("Start / Stop Engine"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("LogiSteeringWheel_lowBeamHeadlightsKB"),
          new GUIContent("Low Beam Headlights"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("LogiSteeringWheel_highBeamHeadlightsKB"),
          new GUIContent("Hıgh Beam Headlights"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("LogiSteeringWheel_hazardIndicatorKB"),
          new GUIContent("Hazard Indicator"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("LogiSteeringWheel_shiftGearUp"),
          new GUIContent("Gear Shift Up"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("LogiSteeringWheel_shiftGearDown"),
          new GUIContent("Gear Shift Down"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("LogiSteeringWheel_boostKB"),
          new GUIContent("Boost / NOS"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("LogiSteeringWheel_changeCameraKB"),
          new GUIContent("Change Camera"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("LogiSteeringWheel_lookBackKB"),
          new GUIContent("Look Back"));
      ...
      if (RCCSettingsAsset.controllerSelectedIndex == 5) {
        ...
        GUI.color = new Color(.75f, 1f, .75f);
        EditorGUILayout.HelpBox(
          "In this mode, RCC won't receive these inputs from keyboard or UI buttons. You need to feed these inputs in your own script.",
          MessageType.Info);
        EditorGUILayout.HelpBox(
          "All inputs are processed by RCC_InputManager script. Open the script and you can see all controller types here. Scroll down to ''Custom'' case and use your own values here.",
          MessageType.Info);
        EditorGUILayout.Space();
        EditorGUILayout.HelpBox(
          "RCC uses these inputs; \n  \n    throttleInput = Clamped 0f - 1f.  \n    brakeInput = Clamped 0f - 1f.  \n    steerInput = Clamped -1f - 1f. \n    clutchInput = Clamped 0f - 1f. \n    handbrakeInput = Clamped 0f - 1f. \n    boostInput = Clamped 0f - 1f.",
          MessageType.Info);
        EditorGUILayout.Space();
        GUI.color = originalGUIColor;
...
//			}
      ...
      EditorGUILayout.PropertyField(serializedObject.FindProperty("useAutomaticGear"),
        new GUIContent("Use Automatic Gear"));
      EditorGUILayout.PropertyField(serializedObject.FindProperty("useAutomaticClutch"),
        new GUIContent("Use Automatic Clutch"));
      EditorGUILayout.PropertyField(serializedObject.FindProperty("runEngineAtAwake"),
        new GUIContent("Engines Are Running At Awake"));
      ...
      EditorGUILayout.PropertyField(serializedObject.FindProperty("contactParticles"),
        new GUIContent("Contact Particles On Collision"));
    ...
    if (foldWheelPhysics) {
      if (RCC_GroundMaterials.Instance.frictions != null && RCC_GroundMaterials.Instance.frictions.Length > 0) {
        ...
        for (int i = 0; i < physicMaterials.Length; i++) {
          ...
          EditorGUILayout.BeginVertical(GUI.skin.box);
          EditorGUILayout.ObjectField("Ground Physic Materials " + i, physicMaterials[i], typeof(PhysicMaterial),
            false);
          EditorGUILayout.EndVertical();
        }
    ...
    if (foldSFX) {
      ...
      EditorGUILayout.PropertyField(serializedObject.FindProperty("audioMixer"), new GUIContent("Main Audio Mixer"),
        false);
      EditorGUILayout.Space();
      EditorGUILayout.PropertyField(serializedObject.FindProperty("crashClips"), new GUIContent("Crashing Sounds"),
        true);
      EditorGUILayout.PropertyField(serializedObject.FindProperty("gearShiftingClips"),
        new GUIContent("Gear Shifting Sounds"), true);
      EditorGUILayout.PropertyField(serializedObject.FindProperty("indicatorClip"), new GUIContent("Indicator Clip"),
        true);
      EditorGUILayout.PropertyField(serializedObject.FindProperty("bumpClip"), new GUIContent("Bump Clip"), true);
      EditorGUILayout.PropertyField(serializedObject.FindProperty("exhaustFlameClips"),
        new GUIContent("Exhaust Flame Clips"), true);
      ...
      EditorGUILayout.Space();
      EditorGUILayout.PropertyField(serializedObject.FindProperty("reversingClip"),
        new GUIContent("Reverse Transmission Sound"), true);
    ...
    if (foldOptimization) {
      ...
      EditorGUILayout.Space();
      EditorGUILayout.PropertyField(serializedObject.FindProperty("useLightsAsVertexLights"),
        new GUIContent("Use Lights As Vertex Lights On Vehicles"));
      GUI.color = new Color(.75f, 1f, .75f);
      EditorGUILayout.HelpBox(
        "Always use vertex lights for mobile platform. Even only one pixel light will drop your performance dramaticaly!",
        MessageType.Info);
      GUI.color = originalGUIColor;
      EditorGUILayout.PropertyField(serializedObject.FindProperty("useLightProjectorForLightingEffect"),
        new GUIContent("Use Light Projector For Lighting Effect"));
      GUI.color = new Color(.75f, .75f, 0f);
      EditorGUILayout.HelpBox(
        ...
        MessageType.Warning);
      GUI.color = originalGUIColor;
      EditorGUILayout.PropertyField(serializedObject.FindProperty("projectorIgnoreLayer"),
        new GUIContent("Light Projector Ignore Layer"));
      GUI.color = new Color(.75f, 1f, .75f);
      EditorGUILayout.HelpBox(
        "For ex, 4 Audio Sources will be created for each wheelslip SFX. This option merges them to only 1 Audio Source.",
        MessageType.Info);
      GUI.color = originalGUIColor;
      EditorGUILayout.PropertyField(serializedObject.FindProperty("dontUseAnyParticleEffects"),
        new GUIContent("Do Not Use Any Particle Effects"));
      EditorGUILayout.PropertyField(serializedObject.FindProperty("dontUseSkidmarks"),
        new GUIContent("Do Not Use Skidmarks"));
    ...
    if (foldTagsAndLayers) {
      ...
      EditorGUILayout.PropertyField(serializedObject.FindProperty("setTagsAndLayers"),
        new GUIContent("Set Tags And Layers Auto"), false);

      if (RCCSettingsAsset.setTagsAndLayers) {
        EditorGUILayout.PropertyField(serializedObject.FindProperty("RCCLayer"), new GUIContent("Vehicle Layer"),
          false);
        EditorGUILayout.PropertyField(serializedObject.FindProperty("RCCTag"), new GUIContent("Vehicle Tag"), false);
        EditorGUILayout.PropertyField(serializedObject.FindProperty("tagAllChildrenGameobjects"),
          new GUIContent("Tag All Children Gameobjects"), false);
        GUI.color = new Color(.75f, 1f, .75f);
    ...
    EditorGUILayout.PropertyField(serializedObject.FindProperty("reverseLights"), new GUIContent("Reverse Lights"),
      false);
    EditorGUILayout.PropertyField(serializedObject.FindProperty("indicatorLights"), new GUIContent("Indicator Lights"),
      false);
    EditorGUILayout.PropertyField(serializedObject.FindProperty("lightTrailers"), new GUIContent("Light Trailers"),
      false);
    EditorGUILayout.PropertyField(serializedObject.FindProperty("mirrors"), new GUIContent("Mirrors"), false);
    EditorGUILayout.PropertyField(serializedObject.FindProperty("skidmarksManager"),
      new GUIContent("Skidmarks Manager"), false);
    ...
    EditorGUILayout.PropertyField(serializedObject.FindProperty("chassisJoint"), new GUIContent("Chassis Joint"),
      false);

    EditorGUILayout.PropertyField(serializedObject.FindProperty("RCCMainCamera"), new GUIContent("RCC Main Camera"),
      false);
    EditorGUILayout.PropertyField(serializedObject.FindProperty("hoodCamera"), new GUIContent("Hood Camera"), false);
    EditorGUILayout.PropertyField(serializedObject.FindProperty("cinematicCamera"), new GUIContent("Cinematic Camera"),
      false);

    EditorGUILayout.PropertyField(serializedObject.FindProperty("RCCCanvas"), new GUIContent("RCC UI Canvas"), false);
    EditorGUILayout.PropertyField(serializedObject.FindProperty("RCCTelemetry"), new GUIContent("RCC Telemetry Canvas"),
      false);
    ...
    EditorGUILayout.LabelField("Created by Buğra Özdoğanlar", EditorStyles.centeredGreyMiniLabel,
