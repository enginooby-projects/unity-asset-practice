...
public class RCC_DetachablePart : MonoBehaviour {
  ...
  public Vector3
    addTorqueAfterLoose = Vector3.zero; //	Adds angular velocity related to speed after the brake point reached.
  ...
  void Update() {
    ...
    if (addTorqueAfterLoose != Vector3.zero && strength <= loosePoint) {
      ...
      rigid.AddRelativeTorque(new Vector3(addTorqueAfterLoose.x * speed, addTorqueAfterLoose.y * speed,
