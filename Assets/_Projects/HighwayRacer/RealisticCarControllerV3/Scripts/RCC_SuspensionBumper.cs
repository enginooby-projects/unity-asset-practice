  ...
  private class SuspensionWheel {
    ...
    public void Move(float distance) {
      wheelCollider.suspensionDistance =
        Mathf.MoveTowards(wheelCollider.suspensionDistance, distance, Time.deltaTime * 50f);
    }
  }
