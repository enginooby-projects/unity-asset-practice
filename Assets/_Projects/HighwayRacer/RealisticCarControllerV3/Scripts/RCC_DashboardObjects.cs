...
public class RCC_DashboardObjects : MonoBehaviour {
  ...
  [Space()] public RPMDial rPMDial;
  [Space()] public SpeedoMeterDial speedDial;
  [Space()] public FuelDial fuelDial;
  [Space()] public HeatDial heatDial;
  [Space()] public InteriorLight[] interiorLights;
