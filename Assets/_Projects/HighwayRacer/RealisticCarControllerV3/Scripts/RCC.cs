...
public class RCC : MonoBehaviour {
  ...
  ///</summary>
  public static RCC_CarControllerV3 SpawnRCC(RCC_CarControllerV3 vehiclePrefab, Vector3 position, Quaternion rotation,
    bool registerAsPlayerVehicle, bool isControllable, bool isEngineRunning) {
  ...
  public static void CleanSkidmarks() {
    RCC_SkidmarksManager.Instance.CleanSkidMark();
  }
  ...
  public static void CleanSkidmarks(int index) {
    RCC_SkidmarksManager.Instance.CleanSkidMark(index);
  }
}