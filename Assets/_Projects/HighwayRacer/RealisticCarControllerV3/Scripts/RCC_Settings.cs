...
public class RCC_Settings : ScriptableObject {
  ...
  public static RCC_Settings Instance {
    get {
      if (instance == null) instance = Resources.Load("RCC Assets/RCC_Settings") as RCC_Settings;
      return instance;
    }
  }
  ...
  public class BehaviorType {
    ...
    [Header("Steering Helpers")] public bool steeringHelper = true;
    ...
    [Space()] public float highSpeedSteerAngleMinimum = 20f;
    ...
    [Space()] public float counterSteeringMinimum = .1f;
    public float counterSteeringMaximum = 1f;

    [Space()] [Range(0f, 1f)] public float steerHelperAngularVelStrengthMinimum = .1f;
    ...
    [Space()] public float antiRollFrontHorizontalMinimum = 1000f;
    public float antiRollRearHorizontalMinimum = 1000f;

    [Space()] [Range(0f, 1f)] public float gearShiftingDelayMaximum = .15f;
    ...
    [Header("Wheel Frictions Forward")] public float forwardExtremumSlip = .4f;
    public float forwardExtremumValue = 1f;
    public float forwardAsymptoteSlip = .8f;
    public float forwardAsymptoteValue = .5f;

    [Header("Wheel Frictions Sideways")] public float sidewaysExtremumSlip = .2f;
